...
SECRET_KEY = 'django-insecure-p(r6@h399dnez%vc+&t2b=3#$jv(w@bg*09q4c2phy*94y5t81'
...
INSTALLED_APPS = [
    ...
    'livereload', # for Auto reload
    'django.contrib.staticfiles',
    'accounts',
    'PIL', # import PIL for uploading image
]

MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',

    'whitenoise.middleware.WhiteNoiseMiddleware', # fix Error while running '$ python manage.py collectstatic --noinput'.
    ...
    'livereload.middleware.LiveReloadScript', # for Auto reload
]
...
DATABASES = {
    'default': {
        # 'ENGINE': 'django.db.backends.postgresql', # previously 
        'ENGINE': 'django.db.backends.sqlite3',
        # 'NAME': 'DEMO_TEST', # previously 
